...
.defines(function(){
    ...
    GameStage = ig.Game.extend({
        ...
        loadLevel: function( data ) {
            ...
            // spawn knight
            ig.game.spawnEntity( EntityKnight, ( this.tileSize * 60 ), ( this.tileSize * 36) );
            
            // spawn wizard
            ig.game.spawnEntity( EntityWizard, ( this.tileSize * 65 ), ( this.tileSize * 36) );
            
            // spawn player
            ig.game.spawnEntity( EntityPlayer, ( this.tileSize * 50 ), ( this.tileSize * 36) );
        },
