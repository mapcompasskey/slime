...
.defines(function() {
    EntityWizard = ig.Entity.extend({
        ...
        init: function( x, y, settings ) {
            ...
            //this.addAnim( 'flat', 0.03, [12, 13, 14, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 19, 18, 18, 18, 18, 17, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 20], true );
            this.addAnim( 'flat', 0.03, [12, 13, 14, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 20], true );
        ...
        update: function() {
            ...
            // track where this entity was standing 
        ...
        isHurting: function() {
            ...
            // if being flattened, kill this entity when the animation ends
            if ( this.flattening ) {
                if ( this.currentAnim == this.anims.flat ) {
                    if ( this.currentAnim.loopCount ) {
                        this.vel.x = 0;
        ...
        animate: function() {
            ...
            if ( this.flattening ) {
                if ( this.currentAnim != this.anims.flat ) {
                    this.currentAnim = this.anims.flat.rewind();
                }
            }
