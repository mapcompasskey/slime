                ...
                if ( this.attacking ) {
                    ...
                    if ( ! this.hasAttacked ) {
                        if ( this.currentAnim.frame == 6 ) {
                            ...
                            var xPos = this.pos.x + ( this.flip ? -6 : 6 );
                            var yPos = this.pos.y + 10;
                            //ig.game.spawnEntity( EntityWizardSpell, xPos, yPos, {caller:this} );
                            this.entitySpell = ig.game.spawnEntity( EntityWizardSpell, xPos, yPos );
                        }
                    }
