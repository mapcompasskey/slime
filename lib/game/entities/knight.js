...
.defines(function() {
    EntityKnight = ig.Entity.extend({
        ...
        init: function( x, y, settings ) {
            ...
            this.addAnim( 'dead_spike', 0.2, [12, 12, 13, 13, 14], true );
        ...
        isHurting: function() {
            ...
            if ( this.spikeDying ) {
                if ( this.currentAnim == this.anims.dead_spike ) {
                    if ( this.currentAnim.loopCount ) {
                        this.vel.y = 0;
                        this.maxVel.y = 0;
                        ig.game.isKnightDead = true;
                    }
                }
            }
        ...
        animate: function() {
            ...
            if ( this.spikeDying ) {
                if ( this.currentAnim != this.anims.dead_spike ) {
                    this.currentAnim = this.anims.dead_spike.rewind();
                }
            }
